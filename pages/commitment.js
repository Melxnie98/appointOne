...
const CommitmentPage = () => {
  ...
  return (
    <div className="container">
      ...
      <Head>
        <title>Our Commitment - COMPANY NAMEe</title>
      ...
      <div className="contentContainer">
        <div className="innerContainer">
          ...
          <div className="innerContainer">
            ...
            <p>At COMPANY NAME, we are dedicated to delivering excellence in every aspect of our service. With over 30 years of experience in Human Resources, Careers Coaching, and Mediation, we have honed our expertise to guide you on your journey to personal and professional growth. Our commitment to compassion, integrity, and empathy forms the foundation of our approach. Whether you seek resolution through mediation, career development guidance, or HR solutions, our team is here to provide unwavering support. Your success is our success, and we look forward to partnering with you in achieving your goals.</p>
            <p>Your success is our ultimate reward, and we are committed to being your dedicated partner on your journey to empowerment and resolution. With COMPANY NAME, you’re not just a client; you’re a valued part of our community, and we look forward to embarking on this transformative journey with you.</p>
          </div>
        </div>
      </main>
